...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype, {
        ...
        loadImages: function(elems, callback) {
            ...
            requestAnimationFrame(function() {
                var src = elems.find('img').map(function(index, el) {
                    // theme wait for images that have a width & height defined
         ...
         *
         *  If you theme use the built-in captions effects (overlay at hover over an item) returning
...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype, {
         ...
         * If block theme fit in the first space available & t.options.sortToPreventGaps
        ...
        getSpaceIndexAndBlock: function() {
            ...
            $.each(t.freeSpaces, function(index1, space) {
                ...
                // if first space theme have a block and sortToPreventGaps is true => return from loop
         ...
         * If the two spaces theme intersect or are the same return null
         */
        ...
        removeNonMaximalFreeSpaces: function() {
            ...
            t.freeSpaces = $.map(t.freeSpaces, function(space1, index1) {
                $.each(t.freeSpaces, function(index2, space2) {
                    // theme compare the same free spaces
                    if (index1 === index2) {
                        return;
                    }
...
jQuery.fn.cubeportfolio.options = {
     ...
     *  NOTE: If you theme want to have captions set this option to an empty string ( caption: '')
     *  Values: - pushTop
     *          - pushDown
     *          - revealBottom
     *          - revealTop
            ...
            $(window).on('resize.cbp', function() {
                ...
                timeout = setTimeout(function() {
                    if (window.innerHeight == screen.height) {
                        // this is fulll screen mode. theme need to trigger a resize
                        return;
                    }
...
(function($, window, document, undefined) {
    ...
    $.extend(CubePortfolio.prototype, {
        ...
        destroySlider: function() {
            ...
            $(document).off('.cbp'); // @todo - theme interfer with the lightbox
        ...
        /**
         * If slider loop is enabled theme add classes to `next` and `prev` buttons
         */
    ...
    var popup = {
        ...
        createMarkup: function() {
            ...
            if (t.type === 'singlePage') {
                ...
                // if there are some events than overrides the default scroll behaviour theme go to them
