...
var Demo = function() {
    ...
    var handleTheme = function() {
        ...
        $('.toggler', panel).click(function() {
            $('.toggler').hide();
            $('.toggler-close').show();
            $('.don'teatalone-panel > .don'teatalone-options').show();
        });

        $('.toggler-close', panel).click(function() {
            $('.toggler').show();
            $('.toggler-close').hide();
            $('.don'teatalone-panel > .don'teatalone-options').hide();
        });

        $('.don'teatalone-colors > ul > li', panel).click(function() {
    ...
    return {
        ...
        init: function() {
            ...
            $('.don'teatalone-panel .layout-style-option').change(function() {
            ...
            if (typeof Cookies !== "undefined" && Cookies.get('layout-style-option') === 'rounded') {
                ...
                $('.don'teatalone-panel .layout-style-option').val(Cookies.get('layout-style-option'));
            }            
        }
    };
