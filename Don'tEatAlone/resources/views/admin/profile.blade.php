                        ...
                        <div class="portlet-body">
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="tab_1_1">
                                    {!! Form::open(['url'=>'adminProfile/'.Auth::user()->id,'class'=>'login-form' ,'method'=>'post']) !!}
                                    {!! csrf_field() !!}
                                ...
                                <div class="tab-pane" id="tab_1_2">
                                    ...
                                    {!! Form::open(['url'=>'uploadA/'.Auth::user()->id,'method'=>'post','id'=>'form_sample_2', 'novalidate'=>'novalidate','enctype'=>'multipart/form-data','files' => true]) !!}
                                    {!! csrf_field() !!}
                                    <div class="form-group">
                                ...
                                <div class="tab-pane" id="tab_1_3">
                                    {!! Form::open( ['url'=>'editAPassword/'.Auth::user()->id,'method'=>'post','id'=>'form_sample_2', 'novalidate'=>'novalidate','enctype'=>'multipart/form-data']) !!}
